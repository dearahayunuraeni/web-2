        ...
        <div class="col-4" style="float: right;">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-light">Skincare : 10.200.000</li>
                    <li class="list-group-item bg-light">Pakaian : 3.100.000</li>
                    <li class="list-group-item bg-light">Iphone : 20.800.000</li>
                </ul>
            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label for="produk1" class="custom-control-label">Skincare</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label for="produk3" class="custom-control-label">Iphone</label>
                            </div>
                        </div>
                    </div>
